# nvim-treesitter-queries-wgsl

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-wgsl/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-wgsl/actions/workflows/validate.yml)

Neovim tree-sitter queries for **wgsl**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-wgsl",
...
- [ ] Changes are scoped to `wgsl` — do not include files for other languages
